/* Reconheço que não seria necessario fazer um mock pois já havia
o data em data.js, mas achei interessante aplicar já que foi retratado
no bloco! */

// não foi copiado do data.js, mas sim do retorno na aplicação!
...
const PokemonObj = [
  ...
  },
  {
    ...
    summary: `It can freely detach its jaw to swallow
    large prey whole. It can become too heavy to move, however.`,
  },
  {
    id: 65,
    name: 'Alakazam',
  ...
  },
  {
    ...
    summary: `What sounds like its cry may actually be its
